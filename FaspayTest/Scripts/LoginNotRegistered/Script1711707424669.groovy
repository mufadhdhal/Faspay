...
WebUI.setText(findTestObject('Page_Welcome to Faspay Merchant Page/input_USER NAME_LoginFormaccount'), 'wrongUser')
...
WebUI.setText(findTestObject('Page_Welcome to Faspay Merchant Page/input_PASSWORD_LoginFormcaptcha'), wrongCaptcha)
