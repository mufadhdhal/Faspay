...
WebUI.setText(findTestObject('Page_Welcome to Faspay Merchant Page/input_USER NAME_LoginFormaccount'), 'testing@gmail.com')

WebUI.setEncryptedText(findTestObject('Page_Welcome to Faspay Merchant Page/input_PASSWORD_LoginFormpassword'), '5xx1bkCcAlw=')
